...
const rules: Rule[] = [
	...
	[/^(-?)bl-(.+)$/,         ([_, sign, value]) => ({ "top":            "auto",                   "right": "auto",                    "bottom": desugar(value, { sign }), "left": desugar(value, { sign }) })],
	[/^(-?)tl-(.+)$/,         ([_, sign, value]) => ({ "top":            desugar(value, { sign }), "right": "auto",                    "bottom": "auto",                   "left": desugar(value, { sign }) })],
