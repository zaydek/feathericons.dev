...
// TODO: Upgrade to use <Transition> API from transition.tsx?
export function RouterTransition({ children }: PropsWithChildren) {
...
export function RouterTransitionProvider({ children }: PropsWithChildren) {
