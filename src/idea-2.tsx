...
////   buffer = fs.readFileSync(path.join(process.cwd(), "dist", "_index.html"))
//// } catch {
////   buffer = fs.readFileSync(path.join(process.cwd(), "dist", "index.html"))
////   fs.writeFileSync(path.join(process.cwd(), "dist", "index.html"), path.join(process.cwd(), "dist", "_index.html"))
//// }
