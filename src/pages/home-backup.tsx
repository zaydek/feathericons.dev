...
//// 	return <>
//// 		<div className="flex center h-32 w-32 rounded-1e3 background-color--orange">
...
//// 			{resetButton && <>
//// 				<div className="px-4">
//// 					<div className="flex center h-24 w-24 rounded-1e3 background-color--$light-placeholder-color">
...
//// 					<div className="flex center h-$sidebar-input-height w-$sidebar-input-height rounded-1e3 background-color--$base-color box-shadow--$shadow-6">
...
//// 	<div className="flex center aspect-1.4">
//// 		{/* <div className="-mb-(($main-inset-y_+_$sidebar-label-height)_/_2) h-64 w-64 rounded-1e3 background-color--$placeholder-color"></div> */}
...
//// 		<Section>
//// 			<Label />
//// 			{/* <div className="flex center h-160 rounded-24 background-color--$gray-color box-shadow--$inset-hairline-shadow"> */}
//// 			<div className="flex center h-160">
...
export function Home() {
	return <>
		...
		<div className="-mt-($ribbon-height_+_$rounding) pb-($ribbon-inset-y_*_2) flex justify-center">
			<div className="flex-basis--$main-width">
				...
				<div className="-mt-$rounding flex rounded-b-$rounding background-color--$base-color box-shadow--$shadow-4 [&_>_:nth-child(1)]:flex-grow--1">
					{/* MAIN */}
					<main>
