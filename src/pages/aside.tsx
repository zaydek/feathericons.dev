		...
		>
			<div className="relative flex flex-col">
				...
				>
					...
					<t.TypeCaps className="text-gray-700">
					...
					>
						<div ref={ref} className="flex flex-col overflow-hidden rounded-12 bg-white shadow-[var(--shadow-6),_var(--base-shadow-6)]">
							...
							>
								...
								<t.TypeCaps className="text-gray-700">SVG</t.TypeCaps>
							</DropDownItem>
							<DropDownItem
								// prettier-ignore
								id="jsx"
							...
							>
								...
								<t.TypeCaps className="text-gray-700">REACT</t.TypeCaps>
							</DropDownItem>
							<DropDownItem
								// prettier-ignore
								id="tsx"
							...
							>
								...
								<t.TypeCaps className="text-gray-700">TS REACT</t.TypeCaps>
							</DropDownItem>
						</div>
					</motion.div>
				)}
...
function ActionButton({ icon, onClick, children, ...props }: { icon: SVG } & JSX.IntrinsicElements["button"]) {
	...
	return (
		...
		>
			...
			<t.TypeCaps className="text-gray-700 group-hover/button:group-active/button:text-white">{children}</t.TypeCaps>
		</button>
	)
}
	...
	return (
		<AriaCheckbox className="group/checkbox flex h-24 items-center justify-between" {...props}>
			...
			<div className="flex items-center gap-8">
				...
				<t.TypeCaps className="text-gray-700">{children}</t.TypeCaps>
			</div>
			{/* RHS */}
