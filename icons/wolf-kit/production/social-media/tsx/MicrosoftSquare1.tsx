// https://feathericons.dev/microsoft-square-1
export function MicrosoftSquare1(props: JSX.IntrinsicElements["svg"]) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" {...props}>
		  ...
		  <path d="M12.636 12.636H19V19h-6.364zM5 12.636h6.364V19H5zM12.636 5H19v6.364h-6.364zM5 5h6.364v6.364H5z" fill="#fff" />
		</svg>
	);
}
