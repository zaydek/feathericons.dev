...
export function CardVisa(props: JSX.IntrinsicElements["svg"]) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 32" width="56" height="32" fill="none" {...props}>
		  ...
		  <path clipRule="evenodd" d="M46.255 9.246h-2.631c-.812 0-1.428.245-1.779 1.124l-5.053 12.428h3.57l.714-2.033h4.368c.098.476.406 2.033.406 2.033H49L46.255 9.246Zm-4.2 8.75 1.359-3.79c-.006.01.039-.116.105-.305v-.002c.098-.278.242-.691.343-.991l.237 1.167s.645 3.244.785 3.922h-2.828Z" fill="currentColor" fillRule="evenodd" />
