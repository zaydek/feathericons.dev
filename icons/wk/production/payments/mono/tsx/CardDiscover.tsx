...
export function CardDiscover(props: JSX.IntrinsicElements["svg"]) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 32" width="56" height="32" fill="none" {...props}>
		  ...
		  <path clipRule="evenodd" d="M6 12.451h2.02c2.233 0 3.789 1.45 3.789 3.533a3.54 3.54 0 0 1-1.281 2.709c-.678.563-1.45.815-2.518.815H6V12.45Zm1.745 5.862c.89 0 1.45-.17 1.883-.56.476-.425.763-1.102.763-1.78 0-.675-.287-1.332-.763-1.756-.454-.411-.994-.57-1.883-.57h-.37v4.666h.37Z" fill="currentColor" fillRule="evenodd" />
		  ...
		  <path clipRule="evenodd" d="M49.386 14.534c0-1.32-.91-2.083-2.497-2.083h-2.041v7.057h1.375v-2.835h.18l1.904 2.835H50l-2.221-2.973c1.036-.211 1.607-.92 1.607-2ZM46.625 15.7h-.402v-2.137h.424c.857 0 1.323.359 1.323 1.045 0 .71-.466 1.092-1.345 1.092Z" fill="currentColor" fillRule="evenodd" />
