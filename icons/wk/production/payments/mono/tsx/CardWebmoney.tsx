...
export function CardWebmoney(props: JSX.IntrinsicElements["svg"]) {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 32" width="56" height="32" fill="none" {...props}>
		  ...
		  <path d="m30.85 15.614-2.174-2.368-2.415 2.126 2.174 2.415 2.415-2.173ZM24.522 11.314l2.174 2.367 2.415-2.125-2.174-2.368-2.415 2.126ZM32.541 19.72l-2.174-2.367-2.415 2.174 2.174 2.367 2.415-2.174Z" fill="currentColor" />
		  <path d="m30.029 23.681-3.961-4.396 1.11-.966-2.801-3.092 1.11-.966-2.801-3.092 4.396-3.913 1.401 1.498L30.9 6.676l1.4 1.45.918-.822c-.193-.096-.434-.241-.628-.338-1.4-.58-2.898-.966-4.492-.966C22.54 6 18 10.493 18 16s4.541 10 10.145 10c1.836 0 3.527-.483 4.976-1.304.483-.29.918-.58 1.352-.87l-2.029-2.27-2.415 2.125Z" fill="currentColor" />
