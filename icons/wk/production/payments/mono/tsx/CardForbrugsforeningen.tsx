...
//
// https://feathericons.dev/?search=card-forbrugsforeningen
export function CardForbrugsforeningen(props: JSX.IntrinsicElements["svg"]) {
	return (
