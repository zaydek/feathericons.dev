// https://feathericons.dev/?search=jcb
export function Jcb(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 32" width="56" height="32" fill="none" {...props}>
      ...
      <path d="M13.048 8.477c.046-1.85 1.695-3.447 3.532-3.474 1.836-.006 3.67 0 5.506-.002-.005 6.19.01 12.38-.008 18.569-.07 1.828-1.701 3.394-3.52 3.426-1.838.007-3.676.001-5.515.003v-7.726c1.786.422 3.659.601 5.48.321 1.09-.175 2.281-.71 2.65-1.84.271-.966.118-1.983.159-2.975v-2.304h-3.153c-.014 1.524.029 3.05-.023 4.572-.085.935-1.011 1.53-1.893 1.497-1.095.012-3.263-.792-3.263-.792-.005-2.855.032-6.43.048-9.275Z" fill="url(#jcb__b)" />
